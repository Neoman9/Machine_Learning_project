...
from housing_1.entity.config_entity import DataIngestionConfig,DataValidationConfig,DataTransformationConfig, ModelTrainerConfig,ModelEvaluationConfig,ModelPushConfig, TrainingPipelineConfig
import sys,os
from housing_1.util.util import read_yaml_file
from housing_1.exception import HousingException
from housing_1.constant import *
...
class Configration:
    ...
    def get_data_validation_config(self) ->DataValidationConfig:
        try:
            ...
            report_file_path = os.path.join(data_validation_artifact_dir,data_validation_config[DATA_VALIDATION_REPORT_PAGE_FILE_NAME_KEY])
