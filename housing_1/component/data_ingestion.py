...
class DataIngestion:
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            data_ingestion_artifact=DataIngestionArtifact(train_file_path=test_file_path,test_file_path=test_file_path,is_ingested=True,message=f"Data ingestion completed succesfully.")
